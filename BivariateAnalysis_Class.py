...
class MethodOfBins:
    ...
    def __init__(self, predictor_var: ndarray, dependent_var: ndarray,
                 *, bin_step: float = None, first_bin_left_boundary: float = None, last_bin_left_boundary: float = None,
        ...
        if bin_step is not None:
            ...
            first_bin_left_boundary = first_bin_left_boundary or np.nanmin(self.predictor_var) - bin_step / 2
            last_bin_left_boundary = last_bin_left_boundary or np.nanmax(self.predictor_var) - bin_step / 2
            self.array_of_bin_boundary = self.__cal_array_of_bin_boundary(bin_step, first_bin_left_boundary,
    ...
    def __cal_array_of_bin_boundary(self, bin_step: float, first_bin_left_boundary: float,
